...
<section class="seccion contenedor">
    ...
    <?php 
        $limite = 3;
        include 'components/anuncios.php';
    ?>

    <div class="alinear-derecha">
        <a href="/usuarios/anuncios" class="boton-verde">Ver Todas</a>
    </div>
</section>
...
<section class="imagen-contacto">
    ...
    <a href="/usuarios/contacto" class="boton-amarillo">Contactános</a>
</section>
